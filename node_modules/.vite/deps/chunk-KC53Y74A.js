  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState3 = React6.useState, useEffect6 = React6.useEffect, useLayoutEffect = React6.useLayoutEffect, useDebugValue = React6.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useRef2 = React6.useRef, useEffect6 = React6.useEffect, useMemo3 = React6.useMemo, useDebugValue = React6.useDebugValue;
...
// node_modules/@liveblocks/react/dist/chunk-N3GS3UTN.mjs
...
function ClientSideSuspense(props) {
  ...
  return React.createElement(React.Suspense, { fallback: props.fallback }, mounted ? typeof props.children === "function" ? props.children() : props.children : props.fallback);
}
...
function useInitial(value) {
  return (0, import_react2.useReducer)(noop, value)[0];
}
...
function internalToExternalState(state) {
  ...
  const cleanedNotifications = (
    ...
    Object.values(computed.inboxNotificationsById).filter(
      (ibn) => {
        var _a;
        return ibn.kind === "thread" ? computed.threadsById[ibn.threadId] && ((_a = computed.threadsById[ibn.threadId]) == null ? void 0 : _a.deletedAt) === void 0 : true;
      }
...
function applyUpsertComment(thread, comment) {
  ...
  if (existingComment === void 0) {
    const updatedAt = new Date(
      Math.max(((_a = thread.updatedAt) == null ? void 0 : _a.getTime()) || 0, comment.createdAt.getTime())
    );
    const updatedThread = {
      ...thread,
      updatedAt,
  ...
  if (existingComment.editedAt === void 0 || comment.editedAt === void 0 || existingComment.editedAt <= comment.editedAt) {
    ...
    const updatedThread = {
      ...
      updatedAt: new Date(
        Math.max(
          ((_b = thread.updatedAt) == null ? void 0 : _b.getTime()) || 0,
          ((_c = comment.editedAt) == null ? void 0 : _c.getTime()) || comment.createdAt.getTime()
        )
      ),
...
function applyAddReaction(thread, commentId, reaction) {
  ...
  return {
    ...thread,
    updatedAt: new Date(
      Math.max(reaction.createdAt.getTime(), ((_a = thread.updatedAt) == null ? void 0 : _a.getTime()) || 0)
    ),
    comments: updatedComments
  };
}
function applyRemoveReaction(thread, commentId, emoji, userId, removedAt) {
  ...
  return {
    ...thread,
    updatedAt: new Date(
      Math.max(removedAt.getTime(), ((_a = thread.updatedAt) == null ? void 0 : _a.getTime()) || 0)
    ),
    comments: updatedComments
  };
}
...
function makeLiveblocksContextBundle(client) {
  ...
  function LiveblocksProvider2(props) {
    ...
    return import_react.default.createElement(ClientContext.Provider, { value: client }, props.children);
  }
...
function useInboxNotifications_withClient(client) {
  ...
  (0, import_react.useEffect)(loadInboxNotifications, [loadInboxNotifications]);
  (0, import_react.useEffect)(startPolling, [startPolling]);
...
function useUser_withClient(client, userId) {
  ...
  const getUserState = (0, import_react.useCallback)(
...
function useRoomInfo_withClient(client, roomId) {
  ...
  const getRoomInfoState = (0, import_react.useCallback)(
...
function useClientOrNull() {
  return (0, import_react.useContext)(ClientContext);
}
function useClient() {
...
function LiveblocksProviderWithClient(props) {
  ...
  return import_react.default.createElement(ClientContext.Provider, { value: props.client }, props.children);
}
function LiveblocksProvider(props) {
  ...
  const client = (0, import_react.useMemo)(() => createClient(options), []);
  return import_react.default.createElement(LiveblocksProviderWithClient, { client }, children);
}
...
function useUserThreads_experimental(options = {
  ...
  const getter = (0, import_react.useCallback)(
...
function useSyncExternalStore2(s, gs, gss) {
  return (0, import_with_selector2.useSyncExternalStoreWithSelector)(s, gs, gss, identity2);
}
...
function handleApiError(err) {
  ...
  if (((_a = err.details) == null ? void 0 : _a.error) === "FORBIDDEN") {
...
function makeRoomContextBundle(client) {
  function RoomProvider_withImplicitLiveblocksProvider(props) {
    return React5.createElement(LiveblocksProviderWithClient, { client, allowNesting: true }, React5.createElement(RoomProvider, { ...props }));
  }
  const shared = createSharedContext(client);
  const bundle = {
    RoomContext,
...
function RoomProviderInner(props) {
  ...
  return React5.createElement(RoomContext.Provider, { value: room }, props.children);
}
function useRoom() {
  const room = useRoomOrNull();
  if (room === null) {
...
function useThreads(options = {
  ...
  const state = (0, import_with_selector2.useSyncExternalStoreWithSelector)(
...
function useDeleteThread() {
  ...
  return React5.useCallback(
    (threadId) => {
      ...
      if (((_b = (_a = thread == null ? void 0 : thread.comments) == null ? void 0 : _a[0]) == null ? void 0 : _b.userId) !== userId) {
...
function useRoomNotificationSettings() {
  ...
  const settings = (0, import_with_selector2.useSyncExternalStoreWithSelector)(
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KC53Y74A.js.map
