...
function I() {
  let r17 = (0, import_react43.useRef)([]), n13 = (0, import_react43.useCallback)((e8) => {
    for (let a20 of r17.current) a20 != null && (typeof a20 == "function" ? a20(e8) : a20.current = e8);
  }, []);
  return (...e8) => {
    if (!e8.every((a20) => a20 == null)) return r17.current = e8, n13;
  };
}
function A(...r17) {
  return r17.every((n13) => n13 == null) ? void 0 : (n13) => {
    for (let e8 of r17) e8 != null && (typeof e8 == "function" ? e8(n13) : e8.current = n13);
  };
}
function N(...r17) {
  var a20;
  ...
  let n13 = {}, e8 = {};
  for (let s13 of r17) for (let t11 in s13) t11.startsWith("on") && typeof s13[t11] == "function" ? ((a20 = e8[t11]) != null || (e8[t11] = []), e8[t11].push(s13[t11])) : n13[t11] = s13[t11];
...
function D4(p6) {
  let r17 = a12(), l14 = (0, import_react80.useContext)(v4), e8 = n9(p6), [o17, n13] = (0, import_react80.useState)(() => {
    var t11;
    if (!r17 && l14 !== null) return (t11 = l14.current) != null ? t11 : null;
...
function R7({ defaultContainers: l14 = [], portals: n13, mainTreeNode: o17 } = {}) {
  let r17 = n9(o17), u17 = o4(() => {
    ...
    for (let e8 of (i15 = r17 == null ? void 0 : r17.querySelectorAll("html > *, body > *")) != null ? i15 : []) e8 !== document.body && e8 !== document.head && e8 instanceof HTMLElement && e8.id !== "headlessui-portal-root" && (o17 && (e8.contains(o17) || e8.contains((c14 = o17 == null ? void 0 : o17.getRootNode()) == null ? void 0 : c14.host)) || t11.some((m9) => e8.contains(m9)) || t11.push(e8));
    return t11;
  });
...
function He2(e8, t11) {
  ...
  let B3 = l9();
  n(() => {
    if (d12 && B3 && b6 === "visible" && r17.current === null) throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [r17, b6, B3, d12]);
...
function _t2(e8, i15) {
  ...
  let o17 = Q("Listbox.Button"), r17 = Z4("Listbox.Button"), a20 = (0, import_react47.useId)(), m9 = u5(), { id: O6 = m9 || `headlessui-listbox-button-${a20}`, disabled: d12 = o17.disabled || false, autoFocus: p6 = false, ...n13 } = e8, u17 = I(), P7 = y(i15, ye(), r17.setButtonElement), t11 = Fe(), s13 = o4((L9) => {
    ...
    var H13;
    if (r4(L9.currentTarget)) return L9.preventDefault();
...
function Bt2(e8, i15) {
  ...
  n(() => {
    ...
    if (!d12) return n13.registerOption(r17, M8);
  }, [M8, r17, d12]);
  let h7 = o4((c14) => {
    var A8;
  ...
  if (n13.focus === c9.Previous) {
    ...
    if (t11 !== null) {
      ...
      if (f21 !== null) {
        ...
        if (((m9 = d12.current) == null ? void 0 : m9.previousElementSibling) === c14.current || ((s13 = c14.current) == null ? void 0 : s13.previousElementSibling) === null) return { ...r17, activeItemIndex: f21 };
      }
    }
    ...
    if (t11 !== null) {
      ...
      if (f21 !== null) {
        let c14 = e8.items[f21].dataRef.current.domRef;
        if (((u17 = d12.current) == null ? void 0 : u17.nextElementSibling) === c14.current || ((a20 = c14.current) == null ? void 0 : a20.nextElementSibling) === null) return { ...r17, activeItemIndex: f21 };
      }
    }
  }
...
function ot(e8, n13) {
  ...
  let r17 = (0, import_react47.useId)(), { id: i15 = `headlessui-menu-button-${r17}`, disabled: o17 = false, autoFocus: p6 = false, ...m9 } = e8, [s13, u17] = w10("Menu.Button"), a20 = Fe(), t11 = I(), d12 = y(n13, ye(), o4((T11) => u17({ type: 7, element: T11 }))), f21 = o4((T11) => {
    ...
    var G7;
    if (r4(T11.currentTarget)) return T11.preventDefault();
...
function ct3(t11, n13) {
  ...
  let [a20] = (0, import_react101.useState)(() => Symbol()), c14 = y(o17, n13, ye(), o4((e8) => {
    if (!i15) {
      if (e8) r17.buttons.current.push(a20);
      else {
    ...
    if (i15) {
      ...
      case o8.Enter:
        ...
        break;
      case o8.Escape:
        if (r17.popoverState !== 0) return y9 == null ? void 0 : y9(r17.buttonId);
...
function Oe2(t11, n13) {
  let P7 = (0, import_react47.useId)(), { id: C10 = `headlessui-popover-backdrop-${P7}`, transition: m9 = false, ...A8 } = t11, [{ popoverState: s13 }, r17] = se4("Popover.Backdrop"), [T11, d12] = (0, import_react101.useState)(null), o17 = y(n13, d12), u17 = u13(), [B3, y9] = R4(m9, T11, u17 !== null ? (u17 & i11.Open) === i11.Open : s13 === 0), b6 = o4((c14) => {
    if (r4(c14.currentTarget)) return c14.preventDefault();
    r17({ type: 1 });
...
function Ue3(o17, t11) {
  let e8 = (0, import_react47.useId)(), a20 = a3(), { id: O6 = `headlessui-radiogroup-${e8}`, value: m9, form: P7, name: i15, onChange: f21, by: c14, disabled: p6 = a20 || false, defaultValue: I7, ...y9 } = o17, T11 = u9(c14), [v5, C10] = (0, import_react102.useReducer)(Fe3, { options: [] }), n13 = v5.options, [U7, h7] = z(), [D9, L9] = U(), A8 = (0, import_react102.useRef)(null), M8 = y(A8, t11), l14 = l2(I7), [s13, _6] = T(m9, f21, l14), R10 = (0, import_react102.useMemo)(() => n13.find((r17) => !r17.propsRef.current.disabled), [n13]), b6 = (0, import_react102.useMemo)(() => n13.some((r17) => T11(r17.propsRef.current.value, s13)), [n13, s13]), d12 = o4((r17) => {
    var u17;
    if (p6 || T11(r17, s13)) return false;
