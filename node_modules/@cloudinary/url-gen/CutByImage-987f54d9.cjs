 ...
 */
class CutByImage extends Action.Action {
    constructor(source) {
        super();
        this.source = source;
    }
    ...
    toString() {
        ...
        close.addQualifier(new Qualifier.Qualifier('fl', 'cutter,fl_layer_apply'));
...
var CutByImage$1 = CutByImage;

exports.CutByImage = CutByImage$1;
