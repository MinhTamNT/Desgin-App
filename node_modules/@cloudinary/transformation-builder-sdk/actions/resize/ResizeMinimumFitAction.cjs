 ...
 */
var ResizeMinimumFitAction = /** @class */ (function (_super) {
    tslib_es6.__extends(ResizeMinimumFitAction, _super);
    function ResizeMinimumFitAction() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return ResizeMinimumFitAction;
