...
var actions_effect_Blur = require('./effect/Blur.cjs');
...
var actions_effect_GenerativeRecolor = require('./effect/GenerativeRecolor.cjs');
var actions_effect_GenerativeBackgroundReplace = require('./effect/GenerativeBackgroundReplace.cjs');
var actions_effect_Extract = require('./effect/Extract.cjs');
...
function blur(blurLevel) {
    return new actions_effect_Blur.BlurAction(blurLevel);
}
/**
 * @summary action
...
function generativeBackgroundReplace() {
    return new actions_effect_GenerativeBackgroundReplace.GenerativeBackgroundReplace();
}
/**
 * @summary action
...
function extract(prompts) {
    return new actions_effect_Extract.Extract(prompts);
}
/**
 * @summary action
...
function generativeRecolor(prompts, color) {
    return new actions_effect_GenerativeRecolor.GenerativeRecolor(prompts, color);
}
/**
 * @summary action
 * @description
...
function generativeRestore() {
    return new actions_effect_EffectActions_SimpleEffectAction.SimpleEffectAction("gen_restore");
}
/**
 * @summary action
 * @description
 ...
 */
function upscale() {
    return new actions_effect_EffectActions_SimpleEffectAction.SimpleEffectAction("upscale");
}
/**
 *
 ...
 */
function enhance() {
    return new actions_effect_EffectActions_SimpleEffectAction.SimpleEffectAction("enhance");
}
/**
