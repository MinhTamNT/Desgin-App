...
var actions_resize_ResizeAdvancedAction = require('./resize/ResizeAdvancedAction.cjs');
var actions_resize_ResizeAutoPadAction = require('./resize/ResizeAutoPadAction.cjs');
...
function auto(width, height) {
    return new actions_resize_ResizeAdvancedAction.ResizeAdvancedAction('auto', width, height);
}
/**
 * @summary action
 * @description
...
function autoPad(width, height) {
    return new actions_resize_ResizeAutoPadAction.ResizeAutoPadAction('auto_pad', width, height);
}
var Resize = {
