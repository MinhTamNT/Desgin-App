  ...
  return (
    <section className="flex flex-col text-white rounded-lg mt-1 bg-gradient-to-br from-[#2a2a2a] to-[#1a1a1a] shadow-lg border border-[#3a3a3a]/30 min-w-[250px] max-w-xs sm:max-w-[300px] sticky left-0 h-full max-sm:hidden select-none overflow-y-auto pb-20">
      ...
      <div className="grid grid-cols-12 gap-2 px-2 py-1">
        <p className="text-xs font-semibold uppercase tracking-wide text-gray-400 col-span-12">
          Function
        </p>

        <div className="grid grid-cols-2 gap-2 col-span-12">
          <button
            onClick={handleExportDesign}
            className="bg-green-600 uppercase p-2 flex items-center whitespace-nowrap hover:bg-green-700 text-white font-bold lg:py-2 lg:px-4 rounded shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110"
            title="Export Design"
          >
          ...
          <button
            ...
            className="bg-purple-600 uppercase p-2 flex items-center whitespace-nowrap hover:bg-purple-700 text-white font-bold lg:py-2 lg:px-4 rounded shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110"
            title="Import Design"
          >
            <FaFileImport size={24} className="mr-2" />
            Import
          </button>
